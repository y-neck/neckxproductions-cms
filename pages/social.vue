<template>
  <div>
    ...
    <div id="content-wrapper" class="bg-background">
      ...
      <h1 class="hidden">Socials</h1>
      <h2 class="px-16">
        Auf diesen sozialen Plattformen kannst du mich erreichen:
      </h2>
      <section
        id="social_section"
      ...
      >
        ...
        <NuxtLink to="https://github.com/y-neck" target="_blank">
          <button role="button" class="socialLink" id="github">
            ...
            >
              <title>Besuche mein GitHub-Profil</title>
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
        ...
        <NuxtLink to="https://instagram.com/neckxproductions" target="_blank">
          <button role="button" class="socialLink" id="instagram">
            ...
            >
              <title>Zur Instagram-Seite von neckXproductions</title>
              <path
                class="cls-1"
